...
//     // Hardcoded demo admin user (stores in Redux)
//     const demoUser = { id: 1, full_name: "Demo Admin", email: "admin@example.com", phone: "", role: "Admin", is_superuser: true };
...
//       // Backend returns user directly on success
//       const user = response;  // Adjust if wrapped: response?.data || response
      
//       if (user && user.id) {
//         // Store user in Redux (including role and is_superuser)
//         dispatch(setUser(user));
//         console.log("Admin user set in Redux:", user);
...
export default function AdminSignInPage() {
  ...
  const handleDemoLogin = async () => {
    ...
    dispatch(setLoading(true));
    // Hardcoded demo admin user - using lowercase "admin" to match form
    const demoUser = { 
      id: 1, 
