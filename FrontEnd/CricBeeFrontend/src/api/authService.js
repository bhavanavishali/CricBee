...
/**
 * Sign Out - Clear local user and call backend to invalidate cookies (optional)
 */
...
/**
 * Get current user from local storage (for UI, e.g., role)
 * @returns {Object|null} User object or null
 */
export const getCurrentUser = () => {
  try {
...
/**
 * Check if user is authenticated (check for user in localStorage; cookies handled by browser)
