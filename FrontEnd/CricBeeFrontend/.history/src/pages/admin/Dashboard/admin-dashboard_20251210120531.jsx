  ...
  const recentActivities = [
    {
      ...
      time: "2 hours ago",
      status: "Live",
      statusColor: "bg-red-900/20 text-red-400"
    },
    {
      icon: DollarSign,
      iconColor: "text-green-400",
      ...
      time: "1 day ago",
      status: "✔ Paid",
      statusColor: "bg-green-900/20 text-green-400"
    },
    {
      icon: Users,
      ...
      time: "2 days ago",
      status: "✓ Completed",
      statusColor: "bg-purple-900/20 text-purple-400"
    },
  ];
      ...
      <Layout title="Admin Dashboard" profilePath="/admin/profile">
        ...
        <main className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-400">Manage your platform and monitor activities from here.</p>
          </div>
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-6">
              ...
              <p className="text-sm text-slate-400">Manage your platform activities</p>
            </div>
              ...
              {quickActions.slice(1).map((action, index) => {
                ...
                return (
                  <div
                    key={index}
                    onClick={() => navigate(action.route)}
                    className={`${action.bgColor} rounded-lg p-6 border border-slate-700 hover:shadow-lg transition-shadow cursor-pointer`}
                  >
                    <div className="flex items-start space-x-4">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-6">
              ...
              <button
                onClick={() => navigate('/admin/transactions')}
                className="text-blue-400 font-semibold flex items-center space-x-1 hover:text-blue-300"
              >
                <span>Latest updates</span>
                <ChevronRight size={18} />
              </button>
            ...
            <div className="bg-slate-800 rounded-lg border border-slate-700 p-6">
              <div className="space-y-4">
                {recentActivities.map((activity, index) => {
                  const Icon = activity.icon;
                  return (
                    <div key={index} className="flex items-start space-x-4 pb-4 border-b border-slate-700 last:border-0 last:pb-0">
                      <div className={`${activity.iconColor} p-2 rounded-lg bg-slate-700`}>
                        <Icon size={20} />
                      </div>
                      <div className="flex-1">
          ...
          {/* Platform Performance Summary */}
          <div className="bg-slate-800 border-2 border-green-800/30 rounded-lg p-6 flex items-center justify-between">
            <div className="flex items-center space-x-4">
