...
def initialize_point_table_for_tournament(
    ...
    If team_ids is not provided, automatically gets all enrolled clubs.
    Called when tournament enrollment is finalized or matches start.
    """
    # If no team_ids provided, get all enrolled clubs for the tournament
    if team_ids is None:
...
def update_point_table_after_match(
    ...
    """
    Update point table after a match is completed.
    This function is called automatically when match_status becomes 'completed'.
