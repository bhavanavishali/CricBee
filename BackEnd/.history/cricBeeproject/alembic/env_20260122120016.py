...
# if database_url:
#     config.attributes['connection'] = database_url
...
from app.models.admin.transaction import AdminWallet, Transaction
from app.models.chat import ChatMessage
from app.models.notification from n
...
def run_migrations_offline() -> None:
    ...
    url = config.attributes.get('connection') or config.get_main_option("sqlalchemy.url")
...
def run_migrations_online() -> None:
    ...
    # Create engine directly with the URL to bypass ConfigParser interpolation
